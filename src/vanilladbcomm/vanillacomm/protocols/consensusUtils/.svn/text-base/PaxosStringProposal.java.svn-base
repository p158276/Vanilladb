...
public class PaxosStringProposal extends PaxosProposal {
    ...
    public PaxosStringProposal(String s) {
        msg = s;
    }
    ...
    public int compareTo(PaxosProposal o) {
        if (!(o instanceof PaxosStringProposal))
            throw new ClassCastException("Required StringProposal");
        return msg.compareTo(((PaxosStringProposal) o).msg);
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof PaxosStringProposal)
                && msg.equals(((PaxosStringProposal) obj).msg);
    }
