...
package vanillacomm.protocols.consensusUTO;
...
public class ConsensusUTOSession extends Session {
    ...
    public void handle(Event e) {
        if (e instanceof ChannelInit)
            ...
            try {
                ...
                System.out.println("[ConsensusUTOSession:handle]"
                        + ex.getMessage());
            }
        }
    }
    ...
    public void handleChannelInit(ChannelInit e) {
        ...
        try {
            ...
            System.out.println("[ConsensusUTOSession:handleCI]:1:"
                    + ex.getMessage());
        }
    ...
    public void handleProcessInitEvent(ProcessInitEvent e) {
        ...
        try {
            ...
            System.out.println("[ConsensusUTOSession:handlePI]:1:"
                    + ex.getMessage());
        }
    ...
    private byte[] serialize(LinkedList<ListElement> list) {
        ...
        try {
            ...
            System.out.println("[ConsensusUTOSession:serialize]"
                    + e.getMessage());
        }
