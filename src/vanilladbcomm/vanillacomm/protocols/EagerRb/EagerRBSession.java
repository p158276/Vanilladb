...
package vanillacomm.protocols.EagerRb;
...
public class EagerRBSession extends Session {
    ...
    private void handleProcessInitEvent(ProcessInitEvent event) {
        ...
        deliveredNumbers = new int[processes.getSize()];
    ...
    private void bebDeliver(SendableEvent event) {
        ...
        if (msgID.seqNumber > deliveredNumbers[msgID.process] && !delivered.contains(msgID)) {
    ...
    private void shrinkDelivered(MessageID mid){
        ...
        int old_sn = deliveredNumbers[pid];
